...
- Pickup notes in `/Users/mist83/Code/mec/NEXT.md` — includes deploy status, the open Apple-feed-creds security finding on the apple-trie lambda, and the next concrete artifact to author (Mullmania MDDF Profile 1.0, to live under the mec project / `mec.mullmania.com` — the former development-canon home is retired).
