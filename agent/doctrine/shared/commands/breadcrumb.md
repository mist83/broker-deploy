...
The response shape is fixed: exactly two lines, each starting with **yes** or **no**, em-dash, ≤12 words of reason.
...
No header, no preamble, no recap, no emoji, no follow-up question, no third line. If either is **no**, name the single most blocking gap.
