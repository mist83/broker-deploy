 ...
 * Toasts Everywhere
 * @version 1.1.0
 * @description Toast notification system using ui.mullmania.com design tokens
 * @license MIT
 * 
 * USAGE:
 * <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@latest/tabler-icons.min.css">
 * <link rel="stylesheet" href="https://ui.mullmania.com/style.css">
...
(function(window, document) {
    ...
    function createToast(options) {
        ...
        closeBtn.onmouseenter = function() { this.style.color = 'var(--text-primary, #333333)'; };
        closeBtn.onmouseleave = function() { this.style.color = 'var(--text-secondary, #666666)'; };
