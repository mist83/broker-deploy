...
(function(window, document) {
    ...
    function scanLayoutIssues(reason) {
        ...
        // Degenerate viewport guard: a 0x0 (or sub-pixel) viewport — headless /
        // offscreen render, a backgrounded tab, or a pre-layout mutation — makes
        // getBoundingClientRect compare every element against a zero-width box, so
        // EVERYTHING trips overflow-x-viewport. The scan is meaningless there; bail
        // rather than bury real issues under a storm of false positives.
